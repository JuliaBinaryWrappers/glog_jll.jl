# Autogenerated wrapper script for glog_jll for x86_64-apple-darwin14-cxx03
export libglog
...
const libglog_splitpath = ["lib", "libglog.0.4.0.dylib"]
...
const libglog = "@rpath/libglog.0.dylib"
