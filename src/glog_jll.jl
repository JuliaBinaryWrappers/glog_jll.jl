...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import glog_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("58029095-ecac-58e2-8c2a-e49631082a9d"))
platforms = [Pkg.Artifacts.unpack_platform(e, "glog", artifacts_toml) for e in artifacts["glog"]]
...
if best_platform === nothing
    @debug("Unable to load glog; unsupported platform $(triplet(platform_key_abi()))")
else
